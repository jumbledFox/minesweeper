...
//             ctx,
//             tr,
//             (game.width, game.height, game.bomb_count),
//             menu_bar.height + 2.0,
//         );
//         let button = gui::Button::new(
//             Rect::new(
//                 ((rendering.window_size.x - 19.0) / 2.0).floor(),
//                 rendering.menu_bar_height + 2.0,
//                 19.0,
//                 19.0,
//             ),
//             gui::button::PressMode::Release,
//             false,
//         );
...
//             erasing_flags: false,
//             button,
//             last_explosion: Instant::now(),
//             time_until_next_explosion: 0,
//             rendering, //gui,
...
//         self.rendering.new_game(
//             ctx,
//             (self.game.width, self.game.height, self.game.bomb_count),
//         );
//         self.button = gui::Button::new(
//             Rect::new(
//                 ((self.rendering.window_size.x - 19.0) / 2.0).floor(),
//                 self.rendering.menu_bar_height + 2.0,
//                 19.0,
//                 19.0,
//             ),
//             gui::button::PressMode::Release,
...
//         self.selected_tile
//             .is_some_and(|s| self.game.board[s] == minesweeper::TileType::Unopened)
//     }
...
//             || hovered_tile.x > self.game.width as f32
//             || hovered_tile.y < 0.0
//             || hovered_tile.y > self.game.height as f32
//         {
//             self.selected_tile = None;
//             return;
//         }
//         let hovered_tile_index =
//             hovered_tile.y as usize * self.game.width + hovered_tile.x as usize;
...
//                 if self.game.set_flag(self.erasing_flags, hovered_tile_index) {
...
//             Some(b)
//                 if self.game.bombs.contains(&b)
//                     && !self.rendering.exploded_bombs.contains(&b)
//                     && self.game.board[b] != minesweeper::TileType::Flag =>
//             {
//                 b
//             }
//             _ => {
//                 // Find a random bomb
//                 let random_bomb = self
//                     .game
//                     .bombs
//                     .iter()
//                     .filter(|b| {
...
//         if !self.game.dig(selected_tile) {
//             return;
//         }
...
//         if !self.game.set_flag(self.erasing_flags, selected_tile) {
//             return;
//         };
//         self.rendering.redraw_minefield();
//     }
...
//             0.0,
//             0.0,
//             self.rendering.window_size.x,
//             self.rendering.window_size.y,
//         ));
...
//         println!(
//             "0, (1, 0): {:?}",
//             minesweeper::get_index_from_offset(0, 1, 0, self.game.width, self.game.height)
//         );
//         println!(
//             "0, (0, 1): {:?}",
//             minesweeper::get_index_from_offset(0, 0, 1, self.game.width, self.game.height)
//         );

//         // for (i, b) in self.game.board.iter().enumerate() {
//         //     if i % self.game.width == 0 {
//         //         println!("");
//         //     }
//         //     print!(
//         //         "{}",
...
//                     minesweeper::TileType::Unopened => String::from("[ ]"),
//                     minesweeper::TileType::Flag => String::from(" F "),
//                     minesweeper::TileType::Dug => String::from(" . "),
...
//                 if self.selected_tile_diggable() {
